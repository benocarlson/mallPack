...
data modify entity @e[type=villager, limit=1] Offers.Recipes set value [{buy:{Count:5,id:"minecraft:pig_spawn_egg"}, sell:{Count:1,id:"minecraft:book", tag:{StoredEnchantments:[{id:aqua_affinity, lvl:1}]}}, maxUses:90, rewardExp:false}]
